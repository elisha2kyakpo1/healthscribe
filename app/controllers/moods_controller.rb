class MoodsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mood.save
        format.html { redirect_to timeline_path, notice: 'Mood was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @mood.update(mood_params)
        format.html { redirect_to timeline_path, notice: 'Mood was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to timeline_path, notice: 'Mood was successfully destroyed.' }
