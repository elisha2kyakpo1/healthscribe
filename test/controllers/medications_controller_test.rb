...
class MedicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medication" do
    assert_difference("Medication.count") do
      post medications_url, params: { medication: { comment: @medication.comment, date: @medication.date, name: @medication.name, symptom_id: @medication.symptom_id, time: @medication.time } }
    end
  ...
  test "should update medication" do
    patch medication_url(@medication), params: { medication: { comment: @medication.comment, date: @medication.date, name: @medication.name, symptom_id: @medication.symptom_id, time: @medication.time } }
