...
class SymptomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create symptom" do
    assert_difference("Symptom.count") do
      post symptoms_url, params: { symptom: { comment: @symptom.comment, date: @symptom.date, intensity: @symptom.intensity, name: @symptom.name, time: @symptom.time, user_id: @symptom.user_id } }
    end
  ...
  test "should update symptom" do
    patch symptom_url(@symptom), params: { symptom: { comment: @symptom.comment, date: @symptom.date, intensity: @symptom.intensity, name: @symptom.name, time: @symptom.time, user_id: @symptom.user_id } }
