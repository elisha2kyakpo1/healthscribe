...
class MoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mood" do
    assert_difference("Mood.count") do
      post moods_url, params: { mood: { comment: @mood.comment, date: @mood.date, name: @mood.name, symptom_id: @mood.symptom_id, time: @mood.time } }
    end
  ...
  test "should update mood" do
    patch mood_url(@mood), params: { mood: { comment: @mood.comment, date: @mood.date, name: @mood.name, symptom_id: @mood.symptom_id, time: @mood.time } }
