...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference("Drink.count") do
      post drinks_url, params: { drink: { comment: @drink.comment, date: @drink.date, name: @drink.name, symptom_id: @drink.symptom_id, time: @drink.time } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { comment: @drink.comment, date: @drink.date, name: @drink.name, symptom_id: @drink.symptom_id, time: @drink.time } }
